...
inline void CAddressResolver::fs_CloseRequest(CResolveRequest *_pRequest)
{
...
inline void CAddressResolver::f_CloseAsync(void *_pResolver, NMib::NFunction::TCFunctionMovable<void ()> &&_fOnClosed)
{
