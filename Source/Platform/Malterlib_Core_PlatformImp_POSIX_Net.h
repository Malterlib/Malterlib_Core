...
struct CPOSIXSocket
{
	...
	// The send window the loop bounds this socket's completion sends to, 0 until set; kept here
	// so a window set before the socket was started reaches the registration when it is made
