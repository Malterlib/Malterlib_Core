...
namespace NLocal
{
	...
	struct COptionalFunctions
	{
		...
		NTSTATUS (NTAPI *m_fNtCreateFile)(PHANDLE _phFile, ACCESS_MASK _DesiredAccess, POBJECT_ATTRIBUTES _pObjectAttributes, PIO_STATUS_BLOCK _pIoStatusBlock, PLARGE_INTEGER _pAllocationSize, ULONG _FileAttributes, ULONG _ShareAccess, ULONG _CreateDisposition, ULONG _CreateOptions, PVOID _pEaBuffer, ULONG _EaLength);
		NTSTATUS (NTAPI *m_fNtDeviceIoControlFile)(HANDLE _hFile, HANDLE _hEvent, PIO_APC_ROUTINE _fApcRoutine, PVOID _pApcContext, PIO_STATUS_BLOCK _pIoStatusBlock, ULONG _IoControlCode, PVOID _pInputBuffer, ULONG _InputBufferLength, PVOID _pOutputBuffer, ULONG _OutputBufferLength);
