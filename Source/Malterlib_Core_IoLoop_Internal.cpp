...
// io_uring and IOCP always need rearming. Each applied request replaces the previous arm; only pending requests coalesce.
// Empty requests leave the existing arm unchanged.
