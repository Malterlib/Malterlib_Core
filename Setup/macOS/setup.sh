...
UpdateXcodePlugins()
{
	...
	if $Setting_PatchedLLBuild; then
		if [[ "$XcodeVersion" == "14.2" ]] || [[ "$XcodeVersion" == "14.3" ]] || [[ "$XcodeVersion" == "14.3.1" ]] || [[ "$XcodeVersion" == "15.0" ]] || [[ "$XcodeVersion" == "15.1" ]] || [[ "$XcodeVersion" == "15.2" ]] || [[ "$XcodeVersion" == "15.3" ]] || [[ "$XcodeVersion" == "15.4" ]] || [[ "$XcodeVersion" == "16.0" ]]; then
